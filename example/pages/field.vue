<template>
    <div class="page-field">
        ...
        <div class="page-part">
            <mt-field label="用户名" placeholder="请输入用户名" :attr="{ maxlength: 10 }">
                <img slot="left" src="../assets/100x100.png" width="24" height="24">
            </mt-field>
            ...
            <mt-field label="验证码" placeholder="输入验证码">
                <img slot="right" src="../assets/100x100.png" height="48px" width="100px">
            </mt-field>
